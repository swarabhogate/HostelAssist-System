...
if (!$gatepass || $hodDepartment === '' || strcasecmp(trim((string) $gatepass['department']), trim((string) $hodDepartment)) !== 0) {
    $_SESSION['gatepass_flash'] = "You are not allowed to reject this gatepass.";
...
createNotification(
    ...
    'Your gatepass GP#' . $id . ' has been rejected by HOD.',
    'gatepass',
    $id,
    $targetUrl,
    'hod',
...
notifyFacultyByRole(
    ...
    'warden',
    'Gatepass rejected by HOD',
    'HOD rejected gatepass GP#' . $id . ' for ' . $studentName . '.',
    'gatepass',
    $id,
    $targetUrl,
    null,
...
$_SESSION['gatepass_flash'] = "Gatepass rejected by HOD.";
